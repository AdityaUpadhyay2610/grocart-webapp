...
export const TopNavbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-b border-emerald-900/10 dark:border-white/10 px-4 py-3 md:px-8 shadow-[0_1px_8px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.4)] flex items-center justify-between transition-colors">
      ...
      <div className="flex items-center gap-4">
        {/* Role Switcher Pill */}
        <div className="flex items-center bg-surface-container-low rounded-full px-3.5 py-1.5 border border-surface-variant/50 shadow-inner">
          ...
          <select 
            ...
            className="bg-transparent text-xs font-bold text-on-surface outline-none cursor-pointer pr-4 appearance-none dark:bg-slate-900"
          >
            <option value="customer" className="dark:bg-slate-900 dark:text-white">Customer View</option>
            <option value="retailer" className="dark:bg-slate-900 dark:text-white">Retailer Dashboard</option>
            <option value="admin" className="dark:bg-slate-900 dark:text-white">Admin Portal</option>
          </select>
        </div>

        {/* Profile Avatar */}
        <div className="flex items-center gap-3 pl-3 border-l border-surface-variant/40">
          ...
          <div className="hidden sm:block leading-tight text-left">
            <div className="text-xs font-bold text-on-surface">{userProfile?.name || 'User'}</div>
