            ...
            {recommendedItems.map(item => {
              ...
              return (
                <div 
                  ...
                  className="w-[160px] sm:w-48 flex-shrink-0 bg-white dark:bg-[#111724] border border-slate-100 dark:border-slate-800/80 rounded-3xl p-4 flex flex-col justify-between shadow-sm hover:shadow-md dark:shadow-none transition-all cursor-pointer hover:scale-[1.02] active:scale-98 relative group"
                >
                  ...
                  <div className="flex flex-col flex-1 justify-start mt-2">
                    ...
                    <div className="flex flex-wrap gap-2 justify-between items-center mt-3 pt-2 border-t border-slate-50 dark:border-slate-800/40">
