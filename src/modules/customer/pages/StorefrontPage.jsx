    ...
    <div className="flex flex-col pb-28 select-none w-full max-w-7xl mx-auto min-h-screen bg-transparent relative px-4 animate-fade-in">
      ...
      {paginatedProducts.length > 0 ? (
        <div className="flex flex-col space-y-6 pb-6">
          <div className="grid grid-cols-1 min-[400px]:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3 sm:gap-4 py-6 items-start">
            ...
            return (
              <div 
                ...
                className="h-fit bg-white dark:bg-[#111724] border border-slate-100 dark:border-slate-800/80 rounded-3xl p-4 sm:p-5 flex flex-col justify-between shadow-sm hover:shadow-md dark:shadow-none transition-all cursor-pointer hover:scale-[1.02] active:scale-98 relative group"
              >
                ...
                <div className="flex flex-col flex-1 justify-start text-center mt-2">
                  <div>
                    <h4 className="text-sm font-black text-slate-800 dark:text-slate-200 line-clamp-2 leading-tight min-h-[20px] group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                      {item.itemName}
                    </h4>
                    <p className="text-xs text-slate-400 dark:text-slate-500 mt-1 font-bold">{item.itemQuantity}</p>
                  </div>

                  <div className="flex flex-wrap  justify-between items-center  border-t border-slate-50 dark:border-slate-800/40">
